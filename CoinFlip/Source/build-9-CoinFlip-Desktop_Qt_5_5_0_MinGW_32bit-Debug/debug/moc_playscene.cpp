...
#include "../../9-CoinFlip V2.0/playscene.h"
...
void PlayScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PlayScene::chooseSceneBack)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject PlayScene::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PlayScene.data,
      qt_meta_data_PlayScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PlayScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlayScene.stringdata0))
        return static_cast<void*>(const_cast< PlayScene*>(this));
