...
#include "../../../../QtAV/examples/videowall/VideoWall.h"
...
QT_MOC_LITERAL(6, 44, 4), // "help"
QT_MOC_LITERAL(7, 49, 15) // "changeClockType"

    },
    "VideoWall\0stop\0\0openLocalFile\0openUrl\0"
    "about\0help\0changeClockType"
};
...
void VideoWall::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VideoWall *_t = static_cast<VideoWall *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 5: _t->changeClockType(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject VideoWall::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoWall.data,
      qt_meta_data_VideoWall,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VideoWall::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoWall.stringdata0))
        return static_cast<void*>(const_cast< VideoWall*>(this));
