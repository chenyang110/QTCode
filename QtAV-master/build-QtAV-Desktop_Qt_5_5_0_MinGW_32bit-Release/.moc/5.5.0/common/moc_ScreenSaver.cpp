...
#include "../../../../QtAV/examples/common/ScreenSaver.h"
...
void ScreenSaver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScreenSaver *_t = static_cast<ScreenSaver *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ScreenSaver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ScreenSaver.data,
      qt_meta_data_ScreenSaver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScreenSaver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScreenSaver.stringdata0))
        return static_cast<void*>(const_cast< ScreenSaver*>(this));
