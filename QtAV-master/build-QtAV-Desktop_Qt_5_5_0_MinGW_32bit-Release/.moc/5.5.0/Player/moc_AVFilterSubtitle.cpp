...
#include "../../../../QtAV/examples/player/filters/AVFilterSubtitle.h"
...
void AVFilterSubtitle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVFilterSubtitle::loaded)) {
                *result = 0;
            }
        }
        {
            typedef void (AVFilterSubtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVFilterSubtitle::loadError)) {
                *result = 1;
            }
        }
        {
            typedef void (AVFilterSubtitle::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVFilterSubtitle::fileChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (AVFilterSubtitle::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVFilterSubtitle::autoLoadChanged)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject AVFilterSubtitle::staticMetaObject = {
    { &LibAVFilterVideo::staticMetaObject, qt_meta_stringdata_AVFilterSubtitle.data,
      qt_meta_data_AVFilterSubtitle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AVFilterSubtitle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AVFilterSubtitle.stringdata0))
        return static_cast<void*>(const_cast< AVFilterSubtitle*>(this));
