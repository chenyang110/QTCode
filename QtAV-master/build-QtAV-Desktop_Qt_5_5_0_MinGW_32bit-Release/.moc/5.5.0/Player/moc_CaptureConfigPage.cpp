...
#include "../../../../QtAV/examples/player/config/CaptureConfigPage.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CaptureConfigPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CaptureConfigPage_t qt_meta_stringdata_CaptureConfigPage = {
    {
QT_MOC_LITERAL(0, 0, 17), // "CaptureConfigPage"
QT_MOC_LITERAL(1, 18, 13), // "selectSaveDir"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 16) // "browseCaptureDir"

    },
    "CaptureConfigPage\0selectSaveDir\0\0"
    "browseCaptureDir"
};
...
void CaptureConfigPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectSaveDir(); break;
        case 1: _t->browseCaptureDir(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CaptureConfigPage::staticMetaObject = {
    { &ConfigPageBase::staticMetaObject, qt_meta_stringdata_CaptureConfigPage.data,
      qt_meta_data_CaptureConfigPage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CaptureConfigPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CaptureConfigPage.stringdata0))
