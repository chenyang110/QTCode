...
void QtAV::Subtitle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Subtitle *_t = static_cast<Subtitle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Subtitle::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::loaded)) {
                *result = 0;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::canRenderChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::codecChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::enginesChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::fuzzyMatchChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::contentChanged)) {
                *result = 6;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::rawDataChanged)) {
                *result = 7;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::fileNameChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::dirsChanged)) {
                *result = 9;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::suffixesChanged)) {
                *result = 10;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::supportedSuffixesChanged)) {
                *result = 11;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::engineChanged)) {
                *result = 12;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::delayChanged)) {
                *result = 13;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::fontFileChanged)) {
                *result = 14;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::fontsDirChanged)) {
                *result = 15;
            }
        }
        {
            typedef void (Subtitle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Subtitle::fontFileForcedChanged)) {
                *result = 16;
            }
        }
    }
...
const QMetaObject QtAV::Subtitle::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__Subtitle.data,
      qt_meta_data_QtAV__Subtitle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::Subtitle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__Subtitle.stringdata0))
        return static_cast<void*>(const_cast< Subtitle*>(this));
