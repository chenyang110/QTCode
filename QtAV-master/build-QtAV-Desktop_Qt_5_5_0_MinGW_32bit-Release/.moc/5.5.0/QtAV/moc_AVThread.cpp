...
void QtAV::AVThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVThread::frameDelivered)) {
                *result = 0;
            }
        }
        {
            typedef void (AVThread::*_t)(qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVThread::seekFinished)) {
                *result = 1;
            }
        }
        {
            typedef void (AVThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVThread::eofDecoded)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject QtAV::AVThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QtAV__AVThread.data,
      qt_meta_data_QtAV__AVThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
