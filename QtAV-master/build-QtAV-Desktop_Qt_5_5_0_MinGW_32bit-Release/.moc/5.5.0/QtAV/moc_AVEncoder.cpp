...
#include "../../../../QtAV/src/QtAV/AVEncoder.h"
...
void QtAV::AVEncoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVEncoder::error)) {
                *result = 0;
            }
        }
        {
            typedef void (AVEncoder::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVEncoder::codecNameChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (AVEncoder::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVEncoder::bitRateChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (AVEncoder::*_t)(TimestampMode );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVEncoder::timestampModeChanged)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject QtAV::AVEncoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__AVEncoder.data,
      qt_meta_data_QtAV__AVEncoder,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::AVEncoder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__AVEncoder.stringdata0))
        return static_cast<void*>(const_cast< AVEncoder*>(this));
