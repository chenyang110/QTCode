...
#include "../../../../QtAV/src/QtAV/EncodeFilter.h"
...
void QtAV::AudioEncodeFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioEncodeFilter::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (AudioEncodeFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioEncodeFilter::readyToEncode)) {
                *result = 1;
            }
        }
        {
            typedef void (AudioEncodeFilter::*_t)(const QtAV::Packet & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioEncodeFilter::frameEncoded)) {
                *result = 2;
            }
        }
        {
            typedef void (AudioEncodeFilter::*_t)(qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioEncodeFilter::startTimeChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (AudioEncodeFilter::*_t)(const QtAV::AudioFrame & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioEncodeFilter::requestToEncode)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject QtAV::AudioEncodeFilter::staticMetaObject = {
    { &AudioFilter::staticMetaObject, qt_meta_stringdata_QtAV__AudioEncodeFilter.data,
      qt_meta_data_QtAV__AudioEncodeFilter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::AudioEncodeFilter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__AudioEncodeFilter.stringdata0))
        return static_cast<void*>(const_cast< AudioEncodeFilter*>(this));
...
void QtAV::VideoEncodeFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoEncodeFilter::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (VideoEncodeFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoEncodeFilter::readyToEncode)) {
                *result = 1;
            }
        }
        {
            typedef void (VideoEncodeFilter::*_t)(const QtAV::Packet & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoEncodeFilter::frameEncoded)) {
                *result = 2;
            }
        }
        {
            typedef void (VideoEncodeFilter::*_t)(qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoEncodeFilter::startTimeChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (VideoEncodeFilter::*_t)(const QtAV::VideoFrame & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoEncodeFilter::requestToEncode)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject QtAV::VideoEncodeFilter::staticMetaObject = {
    { &VideoFilter::staticMetaObject, qt_meta_stringdata_QtAV__VideoEncodeFilter.data,
      qt_meta_data_QtAV__VideoEncodeFilter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::VideoEncodeFilter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__VideoEncodeFilter.stringdata0))
        return static_cast<void*>(const_cast< VideoEncodeFilter*>(this));
