...
#include "../../../../QtAV/src/QtAV/VideoFrameExtractor.h"
...
void QtAV::VideoFrameExtractor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::frameExtracted)) {
                *result = 0;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::sourceChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::asyncChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::error)) {
                *result = 3;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::aborted)) {
                *result = 4;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::autoExtractChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::positionChanged)) {
                *result = 6;
            }
        }
        {
            typedef void (VideoFrameExtractor::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoFrameExtractor::precisionChanged)) {
                *result = 7;
            }
        }
    }
...
const QMetaObject QtAV::VideoFrameExtractor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__VideoFrameExtractor.data,
      qt_meta_data_QtAV__VideoFrameExtractor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::VideoFrameExtractor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__VideoFrameExtractor.stringdata0))
        return static_cast<void*>(const_cast< VideoFrameExtractor*>(this));
