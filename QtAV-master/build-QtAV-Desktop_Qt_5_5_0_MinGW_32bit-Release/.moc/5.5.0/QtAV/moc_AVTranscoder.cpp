...
#include "../../../../QtAV/src/QtAV/AVTranscoder.h"
...
void QtAV::AVTranscoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::videoFrameEncoded)) {
                *result = 0;
            }
        }
        {
            typedef void (AVTranscoder::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::audioFrameEncoded)) {
                *result = 1;
            }
        }
        {
            typedef void (AVTranscoder::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::started)) {
                *result = 2;
            }
        }
        {
            typedef void (AVTranscoder::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::stopped)) {
                *result = 3;
            }
        }
        {
            typedef void (AVTranscoder::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::paused)) {
                *result = 4;
            }
        }
        {
            typedef void (AVTranscoder::*_t)(qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::startTimeChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (AVTranscoder::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVTranscoder::asyncChanged)) {
                *result = 6;
            }
        }
    }
...
const QMetaObject QtAV::AVTranscoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__AVTranscoder.data,
      qt_meta_data_QtAV__AVTranscoder,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::AVTranscoder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__AVTranscoder.stringdata0))
        return static_cast<void*>(const_cast< AVTranscoder*>(this));
