...
#include "../../../../QtAV/src/QtAV/VideoOutput.h"
...
void QtAV::VideoOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoOutput::sourceAspectRatioChanged)) {
                *result = 0;
            }
        }
        {
        ...
        {
            typedef void (VideoOutput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoOutput::backgroundColorChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (VideoOutput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoOutput::orientationChanged)) {
                *result = 9;
            }
        }
        {
            typedef void (VideoOutput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoOutput::videoRectChanged)) {
                *result = 10;
            }
        }
        {
            typedef void (VideoOutput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoOutput::videoFrameSizeChanged)) {
                *result = 11;
            }
        }
    }
...
const QMetaObject QtAV::VideoOutput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__VideoOutput.data,
      qt_meta_data_QtAV__VideoOutput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
