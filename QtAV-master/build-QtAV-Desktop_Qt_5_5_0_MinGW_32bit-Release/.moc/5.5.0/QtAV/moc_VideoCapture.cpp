...
#include "../../../../QtAV/src/QtAV/VideoCapture.h"
...
void QtAV::VideoCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::requested)) {
                *result = 0;
            }
        }
        {
            typedef void (VideoCapture::*_t)(const QtAV::VideoFrame & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::frameAvailable)) {
                *result = 1;
            }
        }
        {
            typedef void (VideoCapture::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::imageCaptured)) {
                *result = 2;
            }
        }
        {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::saved)) {
                *result = 4;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::asyncChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::autoSaveChanged)) {
                *result = 6;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::originalFormatChanged)) {
                *result = 7;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::saveFormatChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::qualityChanged)) {
                *result = 9;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::captureNameChanged)) {
                *result = 10;
            }
        }
        {
            typedef void (VideoCapture::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoCapture::captureDirChanged)) {
                *result = 11;
            }
        }
    }
...
const QMetaObject QtAV::VideoCapture::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__VideoCapture.data,
      qt_meta_data_QtAV__VideoCapture,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
