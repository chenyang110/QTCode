...
#include "../../../../QtAV/src/QtAV/AudioOutput.h"
...
void QtAV::AudioOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioOutput::volumeChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (AudioOutput::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioOutput::muteChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (AudioOutput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioOutput::deviceFeaturesChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (AudioOutput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AudioOutput::backendsChanged)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject QtAV::AudioOutput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__AudioOutput.data,
      qt_meta_data_QtAV__AudioOutput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::AudioOutput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AVOutput"))
        return static_cast< AVOutput*>(const_cast< AudioOutput*>(this));
