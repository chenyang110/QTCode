...
#include "../../../../QtAV/src/QtAV/FrameReader.h"
...
void QtAV::FrameReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameReader::frameRead)) {
                *result = 0;
            }
        }
        {
            typedef void (FrameReader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameReader::readEnd)) {
                *result = 1;
            }
        }
        {
            typedef void (FrameReader::*_t)(qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameReader::seekFinished)) {
                *result = 2;
            }
        }
        {
            typedef void (FrameReader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameReader::readMoreRequested)) {
                *result = 3;
            }
        }
        {
            typedef void (FrameReader::*_t)(qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FrameReader::seekRequested)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject QtAV::FrameReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__FrameReader.data,
      qt_meta_data_QtAV__FrameReader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::FrameReader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__FrameReader.stringdata0))
        return static_cast<void*>(const_cast< FrameReader*>(this));
