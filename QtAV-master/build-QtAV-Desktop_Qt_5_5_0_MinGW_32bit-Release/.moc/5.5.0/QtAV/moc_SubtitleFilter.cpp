...
void QtAV::SubtitleFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SubtitleFilter *_t = static_cast<SubtitleFilter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::rectChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::fontChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::colorChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::autoLoadChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::fileChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::canRenderChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::loaded)) {
                *result = 6;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::codecChanged)) {
                *result = 7;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::enginesChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::fuzzyMatchChanged)) {
                *result = 9;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::contentChanged)) {
                *result = 10;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::dirsChanged)) {
                *result = 11;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::suffixesChanged)) {
                *result = 12;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::supportedSuffixesChanged)) {
                *result = 13;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::engineChanged)) {
                *result = 14;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::delayChanged)) {
                *result = 15;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::fontFileChanged)) {
                *result = 16;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::fontsDirChanged)) {
                *result = 17;
            }
        }
        {
            typedef void (SubtitleFilter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SubtitleFilter::fontFileForcedChanged)) {
                *result = 18;
            }
        }
    }
...
const QMetaObject QtAV::SubtitleFilter::staticMetaObject = {
    { &VideoFilter::staticMetaObject, qt_meta_stringdata_QtAV__SubtitleFilter.data,
      qt_meta_data_QtAV__SubtitleFilter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtAV::SubtitleFilter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtAV__SubtitleFilter.stringdata0))
        return static_cast<void*>(const_cast< SubtitleFilter*>(this));
    if (!strcmp(_clname, "SubtitleAPIProxy"))
        return static_cast< SubtitleAPIProxy*>(const_cast< SubtitleFilter*>(this));
