...
#include "../../../../QtAV/src/QtAV/AVDemuxer.h"
...
void QtAV::AVDemuxer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVDemuxer::unloaded)) {
                *result = 0;
            }
        }
        {
            typedef void (AVDemuxer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVDemuxer::userInterrupted)) {
                *result = 1;
            }
        }
        {
            typedef void (AVDemuxer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVDemuxer::loaded)) {
                *result = 2;
            }
        }
        {
        ...
        {
            typedef void (AVDemuxer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AVDemuxer::seekableChanged)) {
                *result = 7;
            }
        }
    }
...
const QMetaObject QtAV::AVDemuxer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtAV__AVDemuxer.data,
      qt_meta_data_QtAV__AVDemuxer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
